...
alias tinker='docker run --rm -it ilsenem/psysh'
alias tinker-php8='docker run --rm -it ilsenem/psysh:0.11.8-php8'
alias tinker-php7='docker run --rm -it  ilsenem/psysh:0.11.8-php7'
